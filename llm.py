...
df['LLM Bounce Type'] = df['Narration'].apply(query_llm)

# --- Step 7: Save Output ---
output_path = "bank_statement_with_llm.xlsx"
df.to_excel(output_path, index=False)
print(f"✅ LLM-based bounce classification complete. File saved at: {output_path}")